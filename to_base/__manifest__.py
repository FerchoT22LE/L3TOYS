...
2. Ấn bản Enterprise
    ...
    'website': 'https://viindoo.com/apps/app/15.0/to_base',
    ...
    'assets': {
        'web.assets_backend': [
            '/to_base/static/src/js/settings.js',
            '/to_base/static/src/js/readonly_state_selection.js',
            ],
        'web.qunit_suite_tests': [
            ('after', '/base/static/tests/base_settings_tests.js', '/to_base/static/tests/helpers/to_base_testing.js'),
            ],
        },
#
